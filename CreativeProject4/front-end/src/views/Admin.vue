...
<div class="admin">
    ...
    <div class="add">
      <div class="form">
        ...
        <input v-model="availability" placeholder="Availability">
        <p></p>
    ...
    <div class="edit">
      ...
      <div class="upload" v-if="findItem">
        ...
        <input v-model="findItem.availability">
        <p></p>
    ...
    async editItem(item) {
      try {
        ...
        await axios.put("/api/items/" + item._id, {
          ...
          availability: this.findItem.availability,
        });
        this.findItem = null;
        this.getItems();
        return true;
